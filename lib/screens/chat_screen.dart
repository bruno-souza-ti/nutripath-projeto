...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    // Aguarda o carregamento do usuário se ainda não terminou
    if (!_usuarioCarregado) await _carregarUsuario();

    // Loga mensagem do utilizador no ficheiro local
    await LogService.instance.logarMensagemChat(
    ...
    try {
      ...
      // Loga resposta da IA no ficheiro local
      await LogService.instance.logarMensagemChat(
        usuarioId: _usuarioId,
        nomeUsuario: _nomeUsuario,
        mensagem: aiText,
